...
Moves Freed Desktop's library to native SQLite, keeps the complete corpus out of renderer memory, and gives the PWA bounded IndexedDB storage with immutable Google Drive synchronization
