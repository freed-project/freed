...
Integrated AI pack ladder, adaptive social scrape memory handling, and global animation controls, plus cleaner sidebar spacing and smarter primary search

### Features

- Integrated AI pack ladder adds a guided path for installing local model packs.
...
- Social scrapes now measure Freed-owned WebKit memory, reclaim stale scraper windows, and keep provider errors scoped to the right settings panel.
