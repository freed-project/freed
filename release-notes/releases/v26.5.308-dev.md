...
- Relax dense graph visual gate
- Fit graph before visual label assertions
- Release perf gates are now more stable
- Graph provider labels now waits for the correct ready state
