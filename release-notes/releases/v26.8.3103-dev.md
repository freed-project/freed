...
- Create one durable PWA signing identity when multiple tabs initialize together
...
- Bind production PWA deployments and main promotion checks to the exact reviewed dev snapshot
- Preserve the same PWA signing identity across WebKit restarts and route teardown failures through the fail-closed promise path
