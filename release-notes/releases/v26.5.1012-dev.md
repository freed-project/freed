...
## Freed v26.5.1012-dev

Safer visual teardown and cleaner installed-build health
...
- Friends graph teardown now guards Pixi cleanup during the Last seen to Map handoff, preventing the fatal error screen from replacing the Map view.
...
- v26.5.1012-dev replaces the failed v26.5.1011-dev validation tag; v26.5.1011-dev did not produce installable artifacts.
