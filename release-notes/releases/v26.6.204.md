...
Facebook group leave now hands off to the provider safely without folding group refresh into normal feed sync, Facebook sync reliability, lower-profile social capture, and stable release validation, and idle Automerge workers stop reliably after queued work drains
