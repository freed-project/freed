...
import { GalaxyLabStarColorRole } from "./star-instance-data.js";
...
describe("Friends Galaxy GPU star palette", () => {
  it("resolves every theme role into one bounded uniform block", () => {
    ...
    const friendOffset =
      GALAXY_LAB_STAR_PALETTE_FLOAT_OFFSET + GalaxyLabStarColorRole.Friend * 4;
    const backgroundOffset =
      GALAXY_LAB_STAR_PALETTE_FLOAT_OFFSET + GalaxyLabStarColorRole.Background * 4;
    const selectionOffset =
      GALAXY_LAB_STAR_PALETTE_FLOAT_OFFSET + GalaxyLabStarColorRole.Selection * 4;
