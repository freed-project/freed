...
export const PRIMARY_SIDEBAR_GAP_WIDTH_PX = 8;
...
export const COMPACT_PRIMARY_SIDEBAR_SNAP_THRESHOLD_PX = 100;
export const NARROW_LABELED_SIDEBAR_THRESHOLD_PX = 230;
export const EXPANDED_SIDEBAR_PADDING_CROSSOVER_WIDTH_PX = 220;
export const EXPANDED_SIDEBAR_ROOMY_PADDING_PX = 12;
