  ...
  return (
    ...
    >
      <div className="theme-floating-panel flex items-center gap-0 rounded-2xl px-3 py-2 shadow-2xl shadow-black/30 sm:gap-3">
        <div className="hidden min-w-0 truncate whitespace-nowrap rounded-full bg-[color:color-mix(in_srgb,var(--theme-accent-secondary)_20%,transparent)] px-2 py-1 text-[0.625rem] font-semibold uppercase tracking-[0.18em] text-[var(--theme-accent-secondary)] sm:block">
          Local preview
        </div>
