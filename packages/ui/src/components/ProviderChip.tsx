...
export function ProviderChip({ provider }: { provider: Platform }) {
  ...
  return (
    <span className="theme-chip inline-flex items-center gap-1.5 whitespace-nowrap rounded-full px-2 py-0.5 text-[0.6875rem] font-medium text-[color:var(--theme-accent-primary)]">
