...
const ICONS: Record<SectionId, ReactNode> = {
  ...
  shortcuts: (
    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 7h14M7 12h.01M11 12h.01M15 12h.01M17 17H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2z" />
    </svg>
  ),
  ai: (
    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function SettingsDialog({ open, onClose }: SettingsDialogProps) {
  ...
  const navStructure: NavStructureItem[] = useMemo(
    () => [
      ...
      ...(sectionById.shortcuts ? [sectionById.shortcuts] : []),
      sectionById.sync!,
      {
        kind: "group",
        label: "Sources",
