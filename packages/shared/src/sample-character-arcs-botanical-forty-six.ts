...
/** Source and stage decisions: BOTANICAL-REGULAR-46-ADMISSION.md. */
export const BOTANICAL_FORTY_SIX_CHARACTER_ARCS: readonly SampleCharacterArc[] = [
  {
    "characterId": "sabine-warmfold",
    "identityNameBase": "Sabine Warmfold",
    "platform": "facebook",
    "bio": "The invitation has changed. The opening is the same.",
    "location": {
      "name": "Wet woodland beside the Potomac in northern Virginia",
      "coordinates": {
        "lat": 39.0,
        "lng": -77.2
      }
