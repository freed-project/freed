...
import {
  ...
  LIBRARY_CORE_SAVED_FEED_PAGE_V2_PROJECTION,
  LIBRARY_CORE_SAVED_FEED_PAGE_V2_REQUEST_SCHEMA,
  LIBRARY_CORE_SAVED_FEED_PAGE_V2_RESPONSE_SCHEMA,
...
import {
  ...
  LIBRARY_CORE_SAVED_ANALYTICS_V2_NESTED_BOUNDS,
  LIBRARY_CORE_SAVED_ANALYTICS_V2_PROJECTION,
  LIBRARY_CORE_SAVED_ANALYTICS_V2_REQUEST_SCHEMA,
  LIBRARY_CORE_SAVED_ANALYTICS_V2_RESPONSE_SCHEMA,
  LIBRARY_CORE_SAVED_ANALYTICS_V2_SOURCE_IDENTITY,
...
import {
  ...
  LIBRARY_CORE_RSS_FEED_DETAIL_REQUEST_SCHEMA,
  LIBRARY_CORE_RSS_FEED_DETAIL_RESPONSE_SCHEMA,
  LIBRARY_CORE_RSS_FEED_DETAIL_SOURCE_IDENTITY,
...
import {
  ...
  LIBRARY_CORE_RSS_FEED_PAGE_PROJECTION,
  LIBRARY_CORE_RSS_FEED_PAGE_REQUEST_SCHEMA,
  LIBRARY_CORE_RSS_FEED_PAGE_RESPONSE_SCHEMA,
...
import {
  ...
  LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_NESTED_BOUNDS,
  LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_PROJECTION,
  LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_REQUEST_SCHEMA,
  LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_RESPONSE_SCHEMA,
  LIBRARY_CORE_ACCOUNT_PICKER_MAXIMUM_LIMIT,
  LIBRARY_CORE_ACCOUNT_PICKER_MAXIMUM_RESPONSE_BYTES,
  LIBRARY_CORE_ACCOUNT_PICKER_NESTED_BOUNDS,
  LIBRARY_CORE_ACCOUNT_PICKER_PROJECTION,
  LIBRARY_CORE_ACCOUNT_PICKER_REQUEST_SCHEMA,
  LIBRARY_CORE_ACCOUNT_PICKER_RESPONSE_SCHEMA,
  LIBRARY_CORE_FRIENDS_DIRECTORY_DEFAULT_LIMIT,
  LIBRARY_CORE_FRIENDS_DIRECTORY_MAXIMUM_LIMIT,
  LIBRARY_CORE_FRIENDS_DIRECTORY_MAXIMUM_RESPONSE_BYTES,
  LIBRARY_CORE_FRIENDS_DIRECTORY_NESTED_BOUNDS,
  LIBRARY_CORE_FRIENDS_DIRECTORY_PROJECTION,
  LIBRARY_CORE_FRIENDS_DIRECTORY_REQUEST_SCHEMA,
  LIBRARY_CORE_FRIENDS_DIRECTORY_RESPONSE_SCHEMA,
  LIBRARY_CORE_FRIENDS_DIRECTORY_SOURCE_IDENTITY,
  LIBRARY_CORE_PERSON_PICKER_MAXIMUM_LIMIT,
  LIBRARY_CORE_PERSON_PICKER_MAXIMUM_RESPONSE_BYTES,
  LIBRARY_CORE_PERSON_PICKER_NESTED_BOUNDS,
  LIBRARY_CORE_PERSON_PICKER_PROJECTION,
  LIBRARY_CORE_PERSON_PICKER_REQUEST_SCHEMA,
  LIBRARY_CORE_PERSON_PICKER_RESPONSE_SCHEMA,
...
import {
  ...
  LIBRARY_CORE_CONTENT_FETCH_PAGE_NESTED_BOUNDS,
  LIBRARY_CORE_CONTENT_FETCH_PAGE_PROJECTION,
  LIBRARY_CORE_CONTENT_FETCH_PAGE_REQUEST_SCHEMA,
  LIBRARY_CORE_CONTENT_FETCH_PAGE_RESPONSE_SCHEMA,
  LIBRARY_CORE_CONTENT_FETCH_PAGE_SOURCE_IDENTITY,
...
import {
  ...
  LIBRARY_CORE_FILTER_SCOPE_SUMMARY_NESTED_BOUNDS,
  LIBRARY_CORE_FILTER_SCOPE_SUMMARY_PROJECTION,
  LIBRARY_CORE_FILTER_SCOPE_SUMMARY_REQUEST_SCHEMA,
  LIBRARY_CORE_FILTER_SCOPE_SUMMARY_RESPONSE_SCHEMA,
  LIBRARY_CORE_FILTER_SCOPE_SUMMARY_SOURCE_IDENTITY,
...
export interface PlannedBlockedLibraryCoreQueryDefinition {
  ...
  readonly requestSchema:
    ...
    | typeof LIBRARY_CORE_RSS_FEED_DETAIL_REQUEST_SCHEMA
    | typeof LIBRARY_CORE_RSS_FEED_PAGE_REQUEST_SCHEMA
    ...
    | typeof LIBRARY_CORE_SAVED_FEED_PAGE_V2_REQUEST_SCHEMA
    | typeof LIBRARY_CORE_SAVED_ANALYTICS_REQUEST_SCHEMA
    | typeof LIBRARY_CORE_SAVED_ANALYTICS_V2_REQUEST_SCHEMA
    ...
    | typeof LIBRARY_CORE_CONTENT_FETCH_PAGE_REQUEST_SCHEMA
    ...
    | typeof LIBRARY_CORE_FILTER_SCOPE_SUMMARY_REQUEST_SCHEMA
    | typeof LIBRARY_CORE_FRIENDS_DIRECTORY_REQUEST_SCHEMA
    | typeof LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_REQUEST_SCHEMA
    | typeof LIBRARY_CORE_ACCOUNT_PICKER_REQUEST_SCHEMA
    | typeof LIBRARY_CORE_PERSON_PICKER_REQUEST_SCHEMA
  ...
  readonly responseSchema:
    ...
    | typeof LIBRARY_CORE_RSS_FEED_DETAIL_RESPONSE_SCHEMA
    | typeof LIBRARY_CORE_RSS_FEED_PAGE_RESPONSE_SCHEMA
    ...
    | typeof LIBRARY_CORE_SAVED_FEED_PAGE_V2_RESPONSE_SCHEMA
    | typeof LIBRARY_CORE_SAVED_ANALYTICS_RESPONSE_SCHEMA
    | typeof LIBRARY_CORE_SAVED_ANALYTICS_V2_RESPONSE_SCHEMA
    ...
    | typeof LIBRARY_CORE_CONTENT_FETCH_PAGE_RESPONSE_SCHEMA
    ...
    | typeof LIBRARY_CORE_FILTER_SCOPE_SUMMARY_RESPONSE_SCHEMA
    | typeof LIBRARY_CORE_FRIENDS_DIRECTORY_RESPONSE_SCHEMA
    | typeof LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_RESPONSE_SCHEMA
    | typeof LIBRARY_CORE_ACCOUNT_PICKER_RESPONSE_SCHEMA
    | typeof LIBRARY_CORE_PERSON_PICKER_RESPONSE_SCHEMA
  ...
  readonly projection:
    ...
    | typeof LIBRARY_CORE_RSS_FEED_PAGE_PROJECTION
    ...
    | typeof LIBRARY_CORE_SAVED_FEED_PAGE_V2_PROJECTION
    | typeof LIBRARY_CORE_SAVED_ANALYTICS_PROJECTION
    | typeof LIBRARY_CORE_SAVED_ANALYTICS_V2_PROJECTION
    | typeof LIBRARY_CORE_FACET_SUMMARY_PROJECTION
    | typeof LIBRARY_CORE_FILTER_SCOPE_SUMMARY_PROJECTION
    | typeof LIBRARY_CORE_FRIENDS_DIRECTORY_PROJECTION
    | typeof LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_PROJECTION
    | typeof LIBRARY_CORE_ACCOUNT_PICKER_PROJECTION
    | typeof LIBRARY_CORE_PERSON_PICKER_PROJECTION
    ...
    | typeof LIBRARY_CORE_CONTENT_FETCH_PAGE_PROJECTION
  ...
  readonly nestedBounds:
    ...
    | typeof LIBRARY_CORE_SAVED_ANALYTICS_V2_NESTED_BOUNDS
    | typeof LIBRARY_CORE_FACET_SUMMARY_NESTED_BOUNDS
    | typeof LIBRARY_CORE_FILTER_SCOPE_SUMMARY_NESTED_BOUNDS
    | typeof LIBRARY_CORE_FRIENDS_DIRECTORY_NESTED_BOUNDS
    | typeof LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_NESTED_BOUNDS
    | typeof LIBRARY_CORE_ACCOUNT_PICKER_NESTED_BOUNDS
    | typeof LIBRARY_CORE_PERSON_PICKER_NESTED_BOUNDS
    | typeof LIBRARY_CORE_PERSONS_GRAPH_NESTED_BOUNDS
    | typeof LIBRARY_CORE_PERSON_DETAIL_NESTED_BOUNDS
    | typeof LIBRARY_CORE_RSS_FEED_DETAIL_NESTED_BOUNDS
    | typeof LIBRARY_CORE_ITEM_DETAIL_NESTED_BOUNDS
    | typeof LIBRARY_CORE_ITEM_READER_BODY_NESTED_BOUNDS
    | typeof LIBRARY_CORE_CONTENT_FETCH_PAGE_NESTED_BOUNDS
...
export const LIBRARY_CORE_QUERY_REGISTRY = {
  ...
  account_link_candidates_v1: plannedQuery({
    defaultLimit: LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_MAXIMUM_LIMIT,
    ...
    totalCountIntent: "none",
    rendererCache: false,
    invalidationKeyIntent: ["account-link-candidates:{account_or_person_id}"],
    currentKinds: [
      "query_normalized_v1::account_link_candidates_v1",
      "PwaLibraryCoreSqliteEngine.query::account_link_candidates_v1",
    ],
    requestSchema: LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_PROJECTION,
    sourceIdentity: LIBRARY_CORE_FRIENDS_DIRECTORY_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_ACCOUNT_LINK_CANDIDATES_NESTED_BOUNDS,
    sortNotApplicable: true,
    resolvedImplementationBlockers: ["runtime_adapter_unimplemented"],
  }),
  account_picker_page_v1: plannedQuery({
    defaultLimit: LIBRARY_CORE_ACCOUNT_PICKER_MAXIMUM_LIMIT,
    ...
    totalCountIntent: "none",
    rendererCache: false,
    invalidationKeyIntent: ["account-picker"],
    currentKinds: [
      "query_normalized_v1::account_picker_page_v1",
      "PwaLibraryCoreSqliteEngine.query::account_picker_page_v1",
    ],
    requestSchema: LIBRARY_CORE_ACCOUNT_PICKER_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_ACCOUNT_PICKER_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_ACCOUNT_PICKER_PROJECTION,
    sourceIdentity: LIBRARY_CORE_FRIENDS_DIRECTORY_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_ACCOUNT_PICKER_NESTED_BOUNDS,
    sortNotApplicable: true,
    resolvedImplementationBlockers: ["runtime_adapter_unimplemented"],
  }),
  ...
  content_fetch_claim_v1: plannedQuery({
    defaultLimit: LIBRARY_CORE_CONTENT_FETCH_PAGE_MAXIMUM_LIMIT,
    ...
    currentKinds: [
      "query_normalized_v1::content_fetch_claim_v1",
      "PwaLibraryCoreSqliteEngine.query::content_fetch_claim_v1",
      "ContentFetcher::scanLibraryCoreContentFetchCandidates",
    ],
    requestSchema: LIBRARY_CORE_CONTENT_FETCH_PAGE_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_CONTENT_FETCH_PAGE_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_CONTENT_FETCH_PAGE_PROJECTION,
    sourceIdentity: LIBRARY_CORE_CONTENT_FETCH_PAGE_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_CONTENT_FETCH_PAGE_NESTED_BOUNDS,
    stableSort: {
      columns: [
        { column: "publishedAt", direction: "desc" },
        { column: "globalId", direction: "asc" },
  ...
  filter_scope_summary_v1: plannedQuery({
    defaultLimit: 1,
    maximumLimit: 1,
    maximumRows: 1,
    maximumResponseBytes:
    ...
    totalCountIntent: "exact",
    rendererCache: true,
    invalidationKeyIntent: ["filter-scope:{feed_url_or_provider_author}"],
    currentKinds: [
      "query_normalized_v1::filter_scope_summary_v1",
      "PwaLibraryCoreSqliteEngine.query::filter_scope_summary_v1",
    ],
    requestSchema: LIBRARY_CORE_FILTER_SCOPE_SUMMARY_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_FILTER_SCOPE_SUMMARY_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_FILTER_SCOPE_SUMMARY_PROJECTION,
    sourceIdentity: LIBRARY_CORE_FILTER_SCOPE_SUMMARY_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_FILTER_SCOPE_SUMMARY_NESTED_BOUNDS,
    sortNotApplicable: true,
    resolvedImplementationBlockers: ["runtime_adapter_unimplemented"],
  }),
  friends_directory_page_v1: plannedQuery({
    ...
    totalCountIntent: "exact",
    rendererCache: true,
    invalidationKeyIntent: ["friends-directory"],
    currentKinds: [
      "query_normalized_v1::friends_directory_page_v1",
      "PwaLibraryCoreSqliteEngine.query::friends_directory_page_v1",
    ],
    requestSchema: LIBRARY_CORE_FRIENDS_DIRECTORY_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_FRIENDS_DIRECTORY_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_FRIENDS_DIRECTORY_PROJECTION,
    sourceIdentity: LIBRARY_CORE_FRIENDS_DIRECTORY_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_FRIENDS_DIRECTORY_NESTED_BOUNDS,
    stableSort: {
      columns: [
        { column: "selectedSort", direction: "asc" },
  ...
  person_picker_page_v1: plannedQuery({
    defaultLimit: LIBRARY_CORE_PERSON_PICKER_MAXIMUM_LIMIT,
    ...
    totalCountIntent: "none",
    rendererCache: false,
    invalidationKeyIntent: ["person-picker"],
    currentKinds: [
      "query_normalized_v1::person_picker_page_v1",
      "PwaLibraryCoreSqliteEngine.query::person_picker_page_v1",
    ],
    requestSchema: LIBRARY_CORE_PERSON_PICKER_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_PERSON_PICKER_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_PERSON_PICKER_PROJECTION,
    sourceIdentity: LIBRARY_CORE_FRIENDS_DIRECTORY_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_PERSON_PICKER_NESTED_BOUNDS,
    stableSort: {
      columns: [
        { column: "relationshipStatus", direction: "asc" },
  ...
  rss_feed_detail_v1: plannedQuery({
    defaultLimit: 1,
    maximumLimit: 1,
    maximumRows: 1,
    ...
    totalCountIntent: "none",
    rendererCache: true,
    invalidationKeyIntent: ["rss_feed:{url}"],
    currentKinds: [
      "query_normalized_v1::rss_feed_detail_v1",
      "PwaLibraryCoreSqliteEngine.query::rss_feed_detail_v1",
    ],
    requestSchema: LIBRARY_CORE_RSS_FEED_DETAIL_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_RSS_FEED_DETAIL_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_RSS_FEED_DETAIL_PROJECTION,
    sourceIdentity: LIBRARY_CORE_RSS_FEED_DETAIL_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_RSS_FEED_DETAIL_NESTED_BOUNDS,
    sortNotApplicable: true,
    resolvedImplementationBlockers: ["runtime_adapter_unimplemented"],
  }),
  rss_feed_page_v1: plannedQuery({
    defaultLimit: LIBRARY_CORE_FRIENDS_IDENTITY_PAGE_DEFAULT_LIMIT,
    maximumLimit: LIBRARY_CORE_FRIENDS_IDENTITY_PAGE_MAXIMUM_LIMIT,
    maximumRows: LIBRARY_CORE_FRIENDS_IDENTITY_PAGE_MAXIMUM_LIMIT,
    maximumResponseBytes:
    ...
    invalidationKeyIntent: ["rss-feeds"],
    currentKinds: [
      "query_normalized_v1::rss_feed_page_v1",
      "PwaLibraryCoreSqliteEngine.query::rss_feed_page_v1",
    ],
    requestSchema: LIBRARY_CORE_RSS_FEED_PAGE_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_RSS_FEED_PAGE_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_RSS_FEED_PAGE_PROJECTION,
    sourceIdentity: LIBRARY_CORE_FRIENDS_IDENTITY_PAGE_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_FRIENDS_IDENTITY_PAGE_NESTED_BOUNDS,
    stableSort: {
  ...
  saved_analytics_v2: plannedQuery({
    defaultLimit: 1,
    maximumLimit: 1,
    maximumRows: 1,
    maximumResponseBytes:
    ...
    invalidationKeyIntent: ["saved-overview"],
    currentKinds: [
      "query_normalized_v1::saved_analytics_v2",
      "PwaLibraryCoreSqliteEngine.query::saved_analytics_v2",
    ],
    requestSchema: LIBRARY_CORE_SAVED_ANALYTICS_V2_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_SAVED_ANALYTICS_V2_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_SAVED_ANALYTICS_V2_PROJECTION,
    sourceIdentity: LIBRARY_CORE_SAVED_ANALYTICS_V2_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_SAVED_ANALYTICS_V2_NESTED_BOUNDS,
    sortNotApplicable: true,
    resolvedImplementationBlockers: ["runtime_adapter_unimplemented"],
  }),
  ...
  saved_feed_page_v2: plannedQuery({
    defaultLimit: LIBRARY_CORE_SAVED_FEED_PAGE_DEFAULT_LIMIT,
    maximumLimit: LIBRARY_CORE_SAVED_FEED_PAGE_MAXIMUM_LIMIT,
    maximumRows: LIBRARY_CORE_SAVED_FEED_PAGE_MAXIMUM_LIMIT,
    maximumResponseBytes: LIBRARY_CORE_SAVED_FEED_PAGE_MAXIMUM_RESPONSE_BYTES,
    ...
    invalidationKeyIntent: ["feed:saved", "feed-facets"],
    currentKinds: [
      "query_normalized_v1::saved_feed_page_v2",
      "PwaLibraryCoreSqliteEngine.query::saved_feed_page_v2",
    ],
    requestSchema: LIBRARY_CORE_SAVED_FEED_PAGE_V2_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_SAVED_FEED_PAGE_V2_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_SAVED_FEED_PAGE_V2_PROJECTION,
    sourceIdentity: LIBRARY_CORE_SAVED_FEED_PAGE_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_SAVED_FEED_PAGE_NESTED_BOUNDS,
    stableSort: {
      columns: [
