...
import {
  ...
  LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_NESTED_BOUNDS,
  LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_PROJECTION,
  LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_REQUEST_SCHEMA,
  LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_RESPONSE_SCHEMA,
  LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_SOURCE_IDENTITY,
...
export interface PlannedBlockedLibraryCoreQueryDefinition {
  ...
  readonly requestSchema:
    ...
    | typeof LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_REQUEST_SCHEMA
  ...
  readonly responseSchema:
    ...
    | typeof LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_RESPONSE_SCHEMA
  ...
  readonly projection:
    ...
    | typeof LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_PROJECTION
  ...
  readonly sourceIdentity:
    ...
    | typeof LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_SOURCE_IDENTITY
  ...
  readonly nestedBounds:
    ...
    | typeof LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_NESTED_BOUNDS
...
export const LIBRARY_CORE_QUERY_REGISTRY = {
  ...
  friend_candidate_review_v1: plannedQuery({
    defaultLimit: LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_MAXIMUM_LIMIT,
    ...
    totalCountIntent: "none",
    rendererCache: false,
    invalidationKeyIntent: ["friend-candidate-review"],
    currentKinds: [
      "query_normalized_v1::friend_candidate_review_v1",
      "PwaLibraryCoreSqliteEngine.query::friend_candidate_review_v1",
    ],
    requestSchema: LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_REQUEST_SCHEMA,
    responseSchema: LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_RESPONSE_SCHEMA,
    projection: LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_PROJECTION,
    sourceIdentity: LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_SOURCE_IDENTITY,
    nestedBounds: LIBRARY_CORE_FRIEND_CANDIDATE_REVIEW_NESTED_BOUNDS,
    sortNotApplicable: true,
    resolvedImplementationBlockers: ["runtime_adapter_unimplemented"],
  }),
