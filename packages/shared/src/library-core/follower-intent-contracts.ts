...
import { LIBRARY_CORE_NATIVE_EXPORT_MAXIMUM_RESPONSE_BYTES } from "./sqlite-contract.generated.js";

export const LIBRARY_CORE_FOLLOWER_INTENT_MEMBER_LIMIT = 1_000;
export const LIBRARY_CORE_FOLLOWER_INTENT_PAGE_MAXIMUM_RECORDS = 128;
