...
export const LIBRARY_CORE_NORMALIZED_SCHEMA_SHA256 = "1c4b0e9a72c07ace2c9c55f60773ffc627e4578fffb9442dcebdc7703bec3546" as const;
...
export const LIBRARY_CORE_SQLITE_MUTATION_PROGRAMS = {
  "feed_item_archive_assignment": {
    "currentClockSql": "SELECT updated_at, operation_id FROM library_field_clocks WHERE entity_type = 'feed_item' AND entity_id = ?1 AND field_path = 'saved_archive_state';",
    "currentValueSql": "SELECT archived_at FROM library_feed_items WHERE global_id = ?1;",
    "entityType": "FeedItem",
    "fieldClockSql": "INSERT INTO library_field_clocks (entity_type, entity_id, field_path, actor_id, counter, operation_id, updated_at) VALUES ('feed_item', ?1, 'saved_archive_state', ?2, ?3, ?4, ?5) ON CONFLICT(entity_type, entity_id, field_path) DO UPDATE SET actor_id = excluded.actor_id, counter = excluded.counter, operation_id = excluded.operation_id, updated_at = excluded.updated_at;",
  ...
  "feed_item_like_assignment": {
    "currentClockSql": "SELECT updated_at, operation_id FROM library_field_clocks WHERE entity_type = 'feed_item' AND entity_id = ?1 AND field_path = 'liked_state';",
    "currentValueSql": "SELECT liked_at FROM library_feed_items WHERE global_id = ?1;",
    "entityType": "FeedItem",
    "fieldClockSql": "INSERT INTO library_field_clocks (entity_type, entity_id, field_path, actor_id, counter, operation_id, updated_at) VALUES ('feed_item', ?1, 'liked_state', ?2, ?3, ?4, ?5) ON CONFLICT(entity_type, entity_id, field_path) DO UPDATE SET actor_id = excluded.actor_id, counter = excluded.counter, operation_id = excluded.operation_id, updated_at = excluded.updated_at;",
    "invalidationTopic": "feed_item",
  ...
  "feed_item_read_assignment": {
    "currentClockSql": "SELECT updated_at, operation_id FROM library_field_clocks WHERE entity_type = 'feed_item' AND entity_id = ?1 AND field_path = 'read_at';",
    "currentValueSql": "SELECT read_at FROM library_feed_items WHERE global_id = ?1;",
    "entityType": "FeedItem",
    "fieldClockSql": "INSERT INTO library_field_clocks (entity_type, entity_id, field_path, actor_id, counter, operation_id, updated_at) VALUES ('feed_item', ?1, 'read_at', ?2, ?3, ?4, ?5) ON CONFLICT(entity_type, entity_id, field_path) DO UPDATE SET actor_id = excluded.actor_id, counter = excluded.counter, operation_id = excluded.operation_id, updated_at = excluded.updated_at;",
    "invalidationTopic": "feed_item",
