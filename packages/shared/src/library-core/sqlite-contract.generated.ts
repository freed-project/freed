...
export const LIBRARY_CORE_SQLITE_MUTATION_PROGRAMS = {
  "account_upsert": {
    ...
    "clockWriteSql": "",
    "currentValueSql": "",
    "dependentDeleteSql": "DELETE FROM library_account_follow_roles WHERE account_id = ?1;",
    "dependentInsertSql": "INSERT OR IGNORE INTO library_account_follow_roles (account_id, role) SELECT ?1, value FROM json_each(?2, '$.followRosterRoles');",
    "entityType": "Account",
