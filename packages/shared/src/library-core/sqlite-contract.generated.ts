...
export const LIBRARY_CORE_NORMALIZED_SCHEMA_SHA256 = "bc57dd78019f95befc952c8927deaa40a89efaeba9cf6f68955d3139e38d01f4" as const;
...
export const LIBRARY_CORE_SQLITE_CHECKPOINT_IMPORT_PROGRAMS = {
  ...
  "90_actor_state": {
    "hasChunkBytes": false,
    "primaryKeyArity": 1,
    "sql": "INSERT INTO library_actors (actor_id, accepted_counter, actor_kind, created_at, public_key, retired_at, updated_at) SELECT json_extract(?1, '$'), json_extract(?2, '$.acceptedCounter'), json_extract(?2, '$.actorKind'), json_extract(?2, '$.createdAt'), json_extract(?2, '$.publicKey'), json_extract(?2, '$.retiredAt'), json_extract(?2, '$.updatedAt');"
  },
  "a0_receipt": {
    "hasChunkBytes": false,
    "primaryKeyArity": 2,
