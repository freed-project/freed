...
export const LIBRARY_CORE_NORMALIZED_OPERATION_SEGMENT_FORMAT = "freed_normalized_operation_segment_v2" as const;
export const LIBRARY_CORE_NORMALIZED_OPERATION_EXPORT_FORMAT = "freed_normalized_operation_export_v2" as const;
export const LIBRARY_CORE_NORMALIZED_OPERATION_SEGMENT_PROTOCOL = "normalized_operation_segments_v2" as const;
export const LIBRARY_CORE_NORMALIZED_OPERATION_SEGMENT_PROTOCOL_VERSION = 2 as const;
export const LIBRARY_CORE_NORMALIZED_OPERATION_SEGMENT_MAXIMUM_RECORDS = 128 as const;
export const LIBRARY_CORE_NORMALIZED_OPERATION_SEGMENT_MAXIMUM_CANONICAL_BYTES = 1048576 as const;
export const LIBRARY_CORE_NORMALIZED_OPERATION_RECORD_MAXIMUM_CANONICAL_BYTES = 131072 as const;
export const LIBRARY_CORE_NORMALIZED_OPERATION_EXPORT_MAXIMUM_RESPONSE_BYTES = 1048576 as const;
...
export const LIBRARY_CORE_DEVICE_CONTACT_DELTA_MAXIMUM_MEMBERS = 64 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MATCH_MAXIMUM_MEMBERS = 64 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_PAGE_MAXIMUM_ROWS = 64 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_REVIEW_MAXIMUM_ROWS = 50 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_CANONICAL_BYTES = 131072 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_MUTATION_CANONICAL_BYTES = 4194304 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_EMAILS = 16 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_PHONES = 16 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_PHOTOS = 4 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_ORGANIZATIONS = 4 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_RESPONSE_BYTES = 1048576 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MAXIMUM_SUGGESTION_ACCOUNTS = 64 as const;
export const LIBRARY_CORE_DEVICE_CONTACT_MUTATION_DIGEST_DOMAIN = "freed.library-core.v1/digest-records/device-contact-mutation\u0000" as const;
...
export const LIBRARY_CORE_CHECKPOINT_PAGE_MAXIMUM_RECORDS = 4096 as const;
...
export const LIBRARY_CORE_NORMALIZED_SCHEMA_SHA256 = "aaa181e3306dece6e7c385f6be6c6c3e6feffdcb8aeb4a9cb7212f599ae99c0f" as const;
...
export const LIBRARY_CORE_CHECKPOINT_RECORD_REGISTRY = [
  ...
  },
  {
    ...
    primaryKey: "pair",
    payload: "actor_capability_query",
    fields: [
      "queryId"
    ]
  },
...
export const LIBRARY_CORE_SQLITE_MUTATION_PROGRAMS = {
  ...
  "feed_item_archive_assignment": {
    ...
    "maximumMembers": 256,
    "optimisticEffectKind": "archive_assignment",
  ...
  "feed_item_like_assignment": {
    ...
    "maximumMembers": 256,
    "optimisticEffectKind": "like_assignment",
    "payloadKind": "boolean_assignment",
    "requiresExistingTarget": true,
    "targetExistsSql": "SELECT EXISTS(SELECT 1 FROM library_feed_items WHERE global_id = ?1);"
  },
  ...
  "feed_item_read_assignment": {
    ...
    "maximumMembers": 256,
    "optimisticEffectKind": "read_assignment",
    "payloadKind": "read_at",
    "requiresExistingTarget": true,
    "targetExistsSql": "SELECT EXISTS(SELECT 1 FROM library_feed_items WHERE global_id = ?1);"
  },
  ...
  "feed_item_saved_assignment": {
    ...
    "maximumMembers": 256,
    "optimisticEffectKind": "saved_assignment",
    "payloadKind": "boolean_assignment",
    "requiresExistingTarget": true,
    "targetExistsSql": "SELECT EXISTS(SELECT 1 FROM library_feed_items WHERE global_id = ?1);"
  },
  ...
  "feed_item_annotations_replace": {
    "clockReadSql": "SELECT updated_at, operation_id FROM library_field_clocks WHERE entity_type = 'feed_item' AND entity_id = ?1 AND field_path = 'annotations';",
    "clockWriteSql": "INSERT INTO library_field_clocks (entity_type, entity_id, field_path, actor_id, counter, operation_id, updated_at) VALUES ('feed_item', ?1, 'annotations', ?2, ?3, ?4, ?5) ON CONFLICT(entity_type, entity_id, field_path) DO UPDATE SET actor_id = excluded.actor_id, counter = excluded.counter, operation_id = excluded.operation_id, updated_at = excluded.updated_at;",
    "currentValueSql": "SELECT json_object('tags', (SELECT json_group_array(tag) FROM (SELECT tag FROM library_feed_item_tags WHERE global_id = ?1 ORDER BY tag COLLATE BINARY)), 'highlights', (SELECT json_group_array(json_object('createdAt', created_at, 'note', note, 'text', text_value, 'textBlobDigest', text_blob_digest)) FROM (SELECT created_at, note, text_value, text_blob_digest FROM library_feed_item_highlights WHERE global_id = ?1 ORDER BY ordinal)));",
    "dependentDeleteSql": [
      "DELETE FROM library_feed_item_tags WHERE global_id = ?1;",
      "DELETE FROM library_feed_item_highlights WHERE global_id = ?1;"
    ],
    "dependentInsertSql": [
      "INSERT INTO library_feed_item_tags (global_id, tag) SELECT ?1, value FROM json_each(?2, '$.tags') WHERE type = 'text';",
      "INSERT INTO library_feed_item_highlights (global_id, ordinal, created_at, note, text_value, text_blob_digest) SELECT ?1, CAST(key AS INTEGER), json_extract(value, '$.createdAt'), json_extract(value, '$.note'), json_extract(value, '$.text'), json_extract(value, '$.textBlobDigest') FROM json_each(?2, '$.highlights');"
    ],
    "entityType": "FeedItem",
    "invalidationTopic": "feed_item",
    "materializeSql": "UPDATE library_feed_items SET updated_at = ?1 WHERE global_id = ?2;",
    "maximumMembers": 256,
    "optimisticEffectKind": "none",
    "payloadKind": "annotations_assignment",
    "requiresExistingTarget": true,
    "targetExistsSql": "SELECT EXISTS(SELECT 1 FROM library_feed_items WHERE global_id = ?1);"
  },
  "feed_item_analysis_replace": {
    "clockReadSql": "SELECT updated_at, operation_id FROM library_field_clocks WHERE entity_type = 'feed_item' AND entity_id = ?1 AND field_path = 'analysis';",
    "clockWriteSql": "INSERT INTO library_field_clocks (entity_type, entity_id, field_path, actor_id, counter, operation_id, updated_at) VALUES ('feed_item', ?1, 'analysis', ?2, ?3, ?4, ?5) ON CONFLICT(entity_type, entity_id, field_path) DO UPDATE SET actor_id = excluded.actor_id, counter = excluded.counter, operation_id = excluded.operation_id, updated_at = excluded.updated_at;",
    "currentValueSql": "SELECT json_object('hasSignals', EXISTS(SELECT 1 FROM library_feed_item_signals WHERE global_id = ?1), 'hasEvent', EXISTS(SELECT 1 FROM library_feed_item_events WHERE global_id = ?1));",
    "dependentDeleteSql": [
      "DELETE FROM library_feed_item_signal_scores WHERE global_id = ?1;",
      "DELETE FROM library_feed_item_signals WHERE global_id = ?1;",
      "DELETE FROM library_feed_item_events WHERE global_id = ?1;"
    ],
    "dependentInsertSql": [
      "INSERT INTO library_feed_item_signals (global_id, version, method, inferred_at) SELECT ?1, json_extract(?2, '$.content_signals.version'), json_extract(?2, '$.content_signals.method'), json_extract(?2, '$.content_signals.inferred_at_ms') WHERE json_type(?2, '$.content_signals') = 'object';",
      "INSERT INTO library_feed_item_signal_scores (global_id, signal, score, tagged) SELECT ?1, json_extract(value, '$.signal'), json_extract(value, '$.score_basis_points') / 10000.0, json_extract(value, '$.tagged') FROM json_each(?2, '$.content_signals.scores');",
      "INSERT INTO library_feed_item_events (global_id, version, method, detected_at, confidence, title, starts_at, ends_at, timezone, location_name, location_url, evidence, evidence_blob_digest) SELECT ?1, json_extract(?2, '$.event_candidate.version'), json_extract(?2, '$.event_candidate.method'), json_extract(?2, '$.event_candidate.detected_at_ms'), json_extract(?2, '$.event_candidate.confidence_basis_points') / 10000.0, json_extract(?2, '$.event_candidate.title'), json_extract(?2, '$.event_candidate.starts_at_ms'), json_extract(?2, '$.event_candidate.ends_at_ms'), json_extract(?2, '$.event_candidate.timezone'), json_extract(?2, '$.event_candidate.location_name'), json_extract(?2, '$.event_candidate.location_url'), json_extract(?2, '$.event_candidate.evidence'), json_extract(?2, '$.event_candidate.evidence_blob_digest') WHERE json_type(?2, '$.event_candidate') = 'object';"
    ],
    "entityType": "FeedItem",
    "invalidationTopic": "feed_item",
    "materializeSql": "UPDATE library_feed_items SET updated_at = ?1 WHERE global_id = ?2;",
    "maximumMembers": 256,
    "optimisticEffectKind": "none",
    "payloadKind": "analysis_assignment",
    "requiresExistingTarget": true,
    "targetExistsSql": "SELECT EXISTS(SELECT 1 FROM library_feed_items WHERE global_id = ?1);"
  },
  "feed_item_priority_assignment": {
    "clockReadSql": "SELECT updated_at, operation_id FROM library_field_clocks WHERE entity_type = 'feed_item' AND entity_id = ?1 AND field_path = 'priority';",
    "clockWriteSql": "INSERT INTO library_field_clocks (entity_type, entity_id, field_path, actor_id, counter, operation_id, updated_at) VALUES ('feed_item', ?1, 'priority', ?2, ?3, ?4, ?5) ON CONFLICT(entity_type, entity_id, field_path) DO UPDATE SET actor_id = excluded.actor_id, counter = excluded.counter, operation_id = excluded.operation_id, updated_at = excluded.updated_at;",
    "currentValueSql": "SELECT json_object('priorityBasisPoints', CAST(round(COALESCE(priority, 0) * 100.0) AS INTEGER), 'priorityComputedAt', priority_computed_at) FROM library_feed_items WHERE global_id = ?1;",
    "dependentDeleteSql": [],
    "dependentInsertSql": [],
    "entityType": "FeedItem",
    "invalidationTopic": "feed_item",
    "materializeSql": "UPDATE library_feed_items SET priority = ?1 / 100.0, priority_computed_at = ?2 WHERE global_id = ?3;",
    "maximumMembers": 256,
    "optimisticEffectKind": "none",
    "payloadKind": "priority_assignment",
    "requiresExistingTarget": true,
    "targetExistsSql": "SELECT EXISTS(SELECT 1 FROM library_feed_items WHERE global_id = ?1);"
  },
  "friend_replace": {
...
export const LIBRARY_CORE_SQLITE_QUERY_PROGRAMS = {
  ...
  "rss_item_summary_v1": {
    "maximumScanRows": 1,
    "countSql": "SELECT 1;",
    "sql": "SELECT sum(totalCount) AS totalCount, sum(unreadCount) AS unreadCount FROM (SELECT count(*) AS totalCount, count(*) - count(read_at) AS unreadCount FROM library_feed_items WHERE rss_feed_url IS NOT NULL UNION ALL SELECT count(*) AS totalCount, count(*) - count(read_at) AS unreadCount FROM library_feed_items WHERE platform = 'rss' AND rss_feed_url IS NULL);"
  },
  "saved_analytics_v2": {
    "maximumScanRows": 1,
