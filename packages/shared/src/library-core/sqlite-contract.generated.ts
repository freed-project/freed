...
export const LIBRARY_CORE_NORMALIZED_SCHEMA_SHA256 = "c965586a5bff79ec1cc48e00ab0921da4d12c8f659324d2b0c474cef8c811ed6" as const;
...
export const LIBRARY_CORE_SQLITE_CHECKPOINT_IMPORT_PROGRAMS = {
  ...
  "b0_blob_descriptor": {
    "hasChunkBytes": false,
    "primaryKeyArity": 1,
    "sql": "INSERT INTO library_blobs (content_digest, byte_length, chunk_bytes, chunk_count, media_type) SELECT json_extract(?1, '$'), json_extract(?2, '$.byteLength'), json_extract(?2, '$.chunkBytes'), json_extract(?2, '$.chunkCount'), json_extract(?2, '$.mediaType') WHERE json_extract(?2, '$.blobContentDigest') = json_extract(?1, '$');"
  },
  "b1_content_chunk": {
    "hasChunkBytes": true,
    "primaryKeyArity": 2,
