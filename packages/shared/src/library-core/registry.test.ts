...
import {
  ...
  FRIEND_REPLACE_TOUCHED_FIELD_REGISTRY_KEYS,
...
> = {
  friend_replace: {
    ...
    payloadSchema: FRIEND_REPLACE_PAYLOAD_SCHEMA,
    touchedFieldRegistryKeys: FRIEND_REPLACE_TOUCHED_FIELD_REGISTRY_KEYS,
    transactionMemberSchema: FRIEND_REPLACE_TRANSACTION_MEMBER_SCHEMA,
  },
...
describe("Library Core operation registry", () => {
  ...
  it("names each destructive relationship cascade instead of hiding it behind a boolean", () => {
    ...
    ).not.toContain("frozen_bulk_contract_unresolved");
    expect(
