...
/** Scene and canon decisions: BOTANICAL-REGULAR-32-ADMISSION.md. */
export const BOTANICAL_THIRTY_TWO_CHARACTER_ARCS: readonly SampleCharacterArc[] = [
  {
    "characterId": "ansel-threadbark",
    "identityNameBase": "Ansel Threadbark",
    "platform": "facebook",
    "bio": "Still growing around the difficult parts.",
    "location": {
      "name": "Limestone ridge in the southern Snake Range, Nevada",
      "coordinates": {
        "lat": 38.9,
        "lng": -114.3
      }
