...
/** Four independently admitted plant episodes; see BOTANICAL-REGULAR-24-ADMISSION.md. */
export const BOTANICAL_TWENTY_FOUR_CHARACTER_ARCS: readonly SampleCharacterArc[] = [
  {
    "characterId": "hester-sweetlip",
    "identityNameBase": "Hester Sweetlip",
    "platform": "instagram",
    "bio": "Hospitality is going better than hunting.",
    "location": {
      "name": "Wet pine savanna in the Big Thicket region",
      "coordinates": {
        "lat": 30.6,
        "lng": -94.4
      }
    ...
    "episodes": [
      {
        ...
        "body": "I had made the entrance sweet and the way down slippery. A wasp arrived. He put his head inside.\n\nFor a while I considered the matter settled.\n\nThen one of his feet tightened on my rim. Another found the edge beside it. He lowered himself farther without giving up either hold. I had attracted an insect who understood the difference between visiting and committing.\n\nThere was no correction I could make. I could not turn the rim inward. I could not close the top. All the growing that had brought me to this shape was finished, at least for this particular pitcher. The wasp had found an advantage in the part I had been most pleased with.\n\nHe shifted his grip. I prepared to regard that as progress. He shifted it back.\n\nBelow him, the whole funnel waited. Above him, his abdomen remained in the sunlight. Between the two he had arranged his legs with an attention to detail I would have admired in almost anyone else.\n\nI had supplied the invitation, the sweetness, the drop. I had also supplied a very good handrail."
      },
      {
        "subject": "pale pitcher plant",
        "platform": "instagram",
  ...
  {
    "characterId": "ambrose-armful",
    "identityNameBase": "Ambrose Armful",
    "platform": "facebook",
    "bio": "Took his time. Is being rushed by flowers.",
    "location": {
      "name": "Sonoran Desert cactus forest east of Tucson",
      "coordinates": {
        "lat": 32.2,
        "lng": -110.6
      }
    ...
    "episodes": [
      {
        ...
        "body": "Before I had arms, snow settled on every spine.\n\nI had spent all that time becoming difficult to touch. Each point was now holding a little more cold against me."
      },
      {
        "subject": "saguaro cactus",
        "platform": "facebook",
        ...
        "body": "The new nub had hardly got clear of my side when it produced a flower.\n\nI spent decades becoming this tall. It has barely become a lump.\n\nThere it is, flowering sideways, making the rest of me look as though I have been putting things off."
      },
      {
        "subject": "saguaro cactus",
        "platform": "facebook",
        ...
        "body": "A bird landed on one arm. Another took the other side.\n\nFor years I had been meaning to do something impressive with all this branching. Now there were feet on the ends of it.\n\nOne bird left. I had that arm back to myself.\n\nIt was less impressive than I had expected."
      },
      {
        "platform": "medium",
        "contentType": "article",
