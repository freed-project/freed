...
export const SOCIAL_PROVIDER_COPY = {
  ...
  substack: {
    ...
    connectedInfo:
      "Freed reads visible Substack pages through a native browser session. Add a publication's RSS feed when you want full essay bodies.",
    memoryPressure:
  ...
  medium: {
    ...
    connectedInfo:
      "Freed reads visible Medium pages through a native browser session. Add an author or publication RSS feed when you want full essay bodies.",
    memoryPressure:
