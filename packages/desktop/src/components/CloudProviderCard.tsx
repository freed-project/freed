 ...
 * layout. Used by both CloudSyncSetupDialog (onboarding) and MobileSyncTab
 * (Settings). Do not duplicate this inline anywhere.
 */

import type { CloudProvider } from "../lib/sync";
import type { ProviderState } from "../hooks/useCloudProviders";
