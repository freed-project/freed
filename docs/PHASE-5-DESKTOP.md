...
- [x] The feed toolbar and Appearance settings now include local card density and interface zoom sliders, and full feed cards render compact, comfortable, or expansive vertical spacing without syncing device display preferences through Automerge
