...
- **Local display scale controls:** The feed toolbar and Appearance settings expose local card density and interface zoom controls, including a 50% to 200% zoom slider that persists on the current device
