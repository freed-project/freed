...
| 5.131 | Store the device-local Google Contacts ledger in normalized SQLite generations, including scalar contact roots, bounded email, phone, photo, and organization children, suggestions, Account links, sync metadata, and one atomic active-generation selector. Native mutation and bounded review-query cutover remains in progress                                                                                                                             | High       | 🚧 In Progress |
