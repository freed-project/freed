...
- **Local display scale controls:** The far-right view menu and Appearance settings group global Theme and Zoom controls together, including a 75% to 200% slider that persists on the current device, while feed-only Card density stays in its own section
