...
- [x] Installed dev-channel builds admit Google Drive through the same native terminal trigger before dispatching the renderer's bounded manual Library sync path
