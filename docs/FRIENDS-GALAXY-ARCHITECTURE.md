...
| Camera and input | The locked camera has native iPhone touch, Mac trackpad pan and pinch, pointer and touch inertia, midpoint anchoring, reduced-motion cancellation, keyboard navigation, far and near clip-safe scale limits, and depth-correct focus inside bounded full-canvas insets. | Reuse these exact primitives in the product engine and complete the maintained accessibility, menu-focus, and search-to-focus workflows. |
