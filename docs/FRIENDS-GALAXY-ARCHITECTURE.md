...
| Camera and input | The locked camera has native iPhone touch, Mac trackpad pan and pinch, pointer and touch inertia, midpoint anchoring, reduced-motion cancellation, keyboard navigation, far and near clip-safe scale limits, depth-correct focus, a separate full-canvas render rectangle plus bounded interaction rectangle, and one accessible graph region with bounded announcements. | Reuse these exact primitives in the product engine and complete the maintained details, menu-focus, and search-to-focus workflows. |
...
| Keyboard and assistive access | The detached lab proves one focusable described region, camera shortcuts, selection and recovery announcements, reduced-motion description, hidden canvases, and no per-star DOM | Add maintained product coverage for Enter details, menu focus restoration, mobile long press, identity-mode description, and search-to-focus |
