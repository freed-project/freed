...
| 6.83 | Install the same normalized device-local Google Contacts generation tables in OPFS SQLite as the native core. Contact roots and bounded child rows remain outside checkpoints and replication, while the worker mutation and visible review-page query cutover remains in progress                                                                                                                                                                         | High       | 🚧 In Progress                                                                                   |
