...
- [x] PWA factory reset clears device preferences and recovery copies, OAuth handoffs, relay and cloud credentials, worker diagnostics, article and geocoding caches, and the local document. Legal acceptance, release channel, and install prompt dismissal remain installation state.
