...
| Native core extraction         | In progress                               | `packages/library-core-native` owns the normalized SQLite schema, query and mutation execution, authority journal, actor verification, checkpoint staging, descriptor-bound database routing, and process leases. Freed Desktop and the headless sidecar open the same final normalized database in a private `library-sqlite` directory with shared connection configuration and exact schema, application, contract, and protocol verification. The sidecar acquires its data-root lease first, creates no historical checkpoint store or backup tree, and reports ready only after normalized SQLite opens. Freed Desktop exposes one closed native query command. Its historical database remains a separate fenced migration source and receives no mirrored normalized writes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Add bounded typed headless checkpoint, query, and mutation ingress, then delete Library semantics from Tauri                                           |
