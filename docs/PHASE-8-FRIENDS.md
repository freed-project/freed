...
| 8.167 | Match the Friends detail rail's vertical card insets to the primary navigation rail, keep both resize rails full-height, and make the per-canvas fitted overview the exact outward interaction ceiling                                                          | Medium     | Done        |
