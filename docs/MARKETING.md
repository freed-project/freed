...
1. **Unified Feed** — One timeline combining X, Facebook, and Instagram, weighted by what YOU care about.

2. **Friend Map** — See where your friends actually are. Real locations from real posts. Facilitate real human connection.
...
- Technical enough to install a browser extension
...
- A Ulysses pact you make with yourself
...
- Apologize for being idealistic
