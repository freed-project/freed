...
| 4.37 | Self-reference-free actor enrollment identity and body derivation with a closed observed-frontier contract | ✓ | Medium |
| 4.38 | Domain-separated actor possession proof and authority certificate construction with deterministic actor-chain genesis | ✓ | Medium |
| 4.39 | Canonical actor enrollment certificate verification against exact accepted authority state without commit authority | ✓ | Medium |
