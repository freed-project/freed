...
| 4.84 | Closed default `feed_page_v1` request, response, source, cursor, compact projection, nested bounds, and fail-closed parser contract with no active adapter | ✓ | Medium |
