...
- [x] Scheduled social attempts persist due, in-flight, contacted, settled, backoff, and blocked state independently per provider; preserve later migration deadlines; rank overdue work fairly; retain timeout ownership until native settlement; and treat content-bearing zero-height Instagram articles as hidden-layout feed content
