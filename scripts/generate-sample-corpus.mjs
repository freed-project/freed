...
const REJECT_TITLE = /\b(?:annotated|animation|artwork|before and after|boy|bridge|building|camera phone|capsule|chart|child|city|comparison|computer.generated|crowd|diagram|dissection|drawing|engraving|etching|family and friends|football|fossil cast|girl|graph|helicopter|highway|hiker|house|human|icon|illustration|labels?|lander|launch|logo|man|map|mezzotint|mission patch|mountaineer|museum|naval|navy|operation|orbiter|painting|people|person|perspective view|portrait|poster|probe|projector|radar data|road|rocket|rover|scout|sculpture|selfie|simulation|skeleton|spacecraft|specimen|stamp|statue|submarine|telescope mirrors|telescope model|ticket|tourist|village|visualization|warship|woman|woodcut)\b/i;
