...
const CAPTURE_ICONS = [
  { id: "x", label: "X", path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
  { id: "rss", label: "RSS", path: "M6.503 20.752c0 1.794-1.456 3.248-3.251 3.248-1.796 0-3.252-1.454-3.252-3.248 0-1.794 1.456-3.248 3.252-3.248 1.795.001 3.251 1.454 3.251 3.248zm-6.503-12.572v4.811c6.05.062 10.96 4.966 11.022 11.009h4.817c-.062-8.71-7.118-15.758-15.839-15.82zm0-3.368c10.58.046 19.152 8.594 19.183 19.188h4.817c-.03-13.231-10.755-23.954-24-24v4.812z" },
  { id: "save", label: "Save", path: "M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2z" },
  { id: "social", label: "Social", path: "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" },
];

const CLIENT_ICONS = [
  { id: "desktop", label: "Desktop", path: "M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z" },
  { id: "mobile", label: "PWA", path: "M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z" },
  { id: "extension", label: "Extension", path: "M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-1.99.9-1.99 2v3.8H3.5c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7H2V20c0 1.1.9 2 2 2h3.8v-1.5c0-1.49 1.21-2.7 2.7-2.7 1.49 0 2.7 1.21 2.7 2.7V22H17c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11z" },
];
...
function ArchitectureDiagram() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl">
      <svg viewBox="0 0 600 250" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
        <defs>
        ...
        {/* Capture Layer */}
        <g>
          <text x="45" y="20" fill="#71717a" fontSize="10" fontWeight="600" textAnchor="middle">
            CAPTURE
          </text>
        ...
        <g transform="translate(250, 75)">
          <text x="50" y="-10" fill="#71717a" fontSize="10" fontWeight="600" textAnchor="middle">
            SYNC HUB
          </text>
          ...
          {/* Automerge CRDT text */}
          <text x="50" y="42" fill="#fafafa" fontSize="11" fontWeight="700" textAnchor="middle">
            Automerge
          </text>
        ...
        {/* Clients */}
        <g>
          <text x="555" y="20" fill="#71717a" fontSize="10" fontWeight="600" textAnchor="middle">
            CLIENTS
          </text>
          {CLIENT_ICONS.map((icon, i) => (
            <g key={icon.id} transform={`translate(530, ${40 + i * 65})`}>
              <motion.rect
                ...
                rx="8"
                fill="rgba(255,255,255,0.03)"
                stroke={i === 0 ? "rgba(139,92,246,0.5)" : "rgba(139,92,246,0.3)"}
                strokeWidth={i === 0 ? "2" : "1"}
                initial={{ opacity: 0.5 }}
              ...
              <g transform="translate(13, 8) scale(1)">
                <path d={icon.path} fill={i === 0 ? "#8b5cf6" : "#a1a1aa"} transform="scale(1)" />
              </g>
              <text x="25" y="52" fill="#71717a" fontSize="8" textAnchor="middle">
                {icon.label}
              </text>
            </g>
          ))}
        ...
        {/* Hub label */}
        <text x="300" y="240" fill="#71717a" fontSize="9" textAnchor="middle" fontStyle="italic">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs text-text-muted bg-freed-surface px-3 py-1 rounded-full">
              Live data flow
            </span>
          </div>
          <ArchitectureDiagram />
