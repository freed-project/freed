...
const phases: Phase[] = [
  ...
  },
  {
    ...
    title: "PWA Reader",
    description:
      "Primary mobile surface with first-run legal gating, URL-backed view state, public-safe bug reporting, and switchable production or dev update channels across `app.freed.wtf` and the persistent prerelease lane at `dev-app.freed.wtf`.",
    status: "complete",
    planLink:
