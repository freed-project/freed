...
const phases: Phase[] = [
  ...
  },
  {
    ...
    description:
      "Facebook and Instagram integrated via Tauri WebView scraping, with suggested-post filtering, long-text expansion, source-level post and story filters, hardened playable story capture, same-platform story duplicate repair, silent background media guarding, serialized background scraper sessions, Facebook group controls, provider health summaries, X reply hydration in the reader, and smart backoff when sync looks rate-limited.",
    status: "current",
    planLink:
