...
const phases: Phase[] = [
  ...
  },
  {
    ...
    title: "Sync Layer",
    description:
      "Local relay and Google Drive sync are working, with server-proxied Google token exchange, dev and preview PWA callback relay, appDataFolder Drive polling, durable Google OAuth refresh, initial Drive download recovery after token refresh, merged-upload local convergence, cloud health diagnostics, visible transfer diagnostics, retry and reconnect actions, debug charts, the timed no-cloud-sync launch banner, and desktop snapshot restore. Dropbox remains gated while its provider work finishes, and iCloud remains the open item.",
    status: "current",
    planLink:
