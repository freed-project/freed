...
const phases: Phase[] = [
  ...
  },
  {
    ...
    description:
      "Facebook and Instagram integrated via Tauri WebView scraping, with suggested-post filtering, source-level post and story filters, hardened playable story capture, same-platform story duplicate repair, silent background media guarding, serialized background scraper sessions, Facebook group controls, provider health summaries, Meta export import, a permanent local archive for the user's own media, and smart backoff when sync looks rate-limited.",
    status: "current",
    planLink:
